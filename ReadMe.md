...
form validation is a peice of code that makes sure the data entered into the form is valid. so if you mistakenly put numbers into the name field or misspelled your email address it will alert you to correct your intput.
